...
function populateDropdown() {
    const countryDropdownContent = document.querySelector("#countryDropdown + .dropdown-content");
    const visaDropdownContent = document.querySelector("#VisaDropdown + .dropdown-content");
    const destinationDropdownContent = document.querySelector("#destinationDropdown + .dropdown-content");
...
function selectOption(buttonId, option) {
    document.getElementById(buttonId).innerHTML = `${option} <i class="fa-solid fa-caret-down"></i>`;
    closeDropdowns();
}
